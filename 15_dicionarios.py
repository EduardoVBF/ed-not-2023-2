"""
    Dicionário é uma estrutura de dados fornecida pela linguagem Phyton, capaz de armazenar
    múltiplos valores em uma única variável, por meio de pares de chave-valor (key-value).

    Um dicionário é delimitado por chaves {}. Diferentemente das listas, que têm posições numeradas,
    os dicionários possuem posições NOMEADAS.

    Cada uma das posições nomeadas de um dicionário (ou seja, um par chave-valor) é chamado PROPRIEDADE.
"""
pessoa = {
...
# Representação de formas geométricas planas
