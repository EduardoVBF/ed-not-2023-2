def bubble_sort(lista):
    ...
    o segundo for MENOR que o primeiro. Efetua tantas passadas
    quanto necessárias, até que, na última delas, 
    nenhuma troca tenha sido realizada
    """

    # Loop eterno, não sabemos de antemão quantas passadas serão necessárias
    while True:
